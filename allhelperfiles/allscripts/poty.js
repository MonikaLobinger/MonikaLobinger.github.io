...
class Setting extends BreadCrumbs {
  ...
  static deepCopy(literal) {
    ...
    if (type !== "object") {
      ...
      newLiteral = {}
      if (Object.keys(Object.getOwnPropertyDescriptors(literal)).length !== Object.keys(literal).length) {}
  ...
  #essenceOfAtom(literal, key, type) {
    ...
    if (typeof specLit == "boolean") {
      if (specLit == true && typeof type == "string" && literal[key]["TYPE"] == undefined) {
...
class TypesWorker extends Setting {
  ...
  static #toPlainString(literal, indent = "\n  ") {
    ...
    for (const [key, value] of Object.entries(literal)) {
      ...
      if (typeof value != "object" || Object.getOwnPropertyNames(value).length === 0 || Array.isArray(value)) {
